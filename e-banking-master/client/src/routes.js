    ...
    return (
      <div>
        <Switch>
          ...
          <Route path="/debit/process/:id" strict exact={true}  component={Debitprocess}/> <Route path="/rcustomer" strict exact={true}  component={Registeredcustomer}/> <Route path="/acontrol" strict exact={true}  component={Admincontrol}/>
